...
exports.handler = async (event) => {
  ...
  try{
    ...
    let peopleRecords = await peopleModel.update({'id': event.queryStringParameters.id}, {'name': event.queryStringParameters.name, 'occupation': event.queryStringParameters.occupation});
    ...
    response.body = JSON.stringify(new Error('Couldn\'t delete from people'));
  }
